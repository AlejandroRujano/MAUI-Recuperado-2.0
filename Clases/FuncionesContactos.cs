...
namespace Prueba_Maui.Clases
{
    public class Funciones
    {
        ...
        public static void LeerJsonContactos()
        {
            ...
            _listaDeContactosOriginal.Add(new Contacto("Luis","Galindez","","a@gmail.com","042425836912",_listaDeContactosOriginal.Count +1,""));
            _listaDeContactosOriginal.Add(new Contacto("Eugenio", "Montilla", " ", "a@gmail.com", "041257632497", _listaDeContactosOriginal.Count + 1, _listaDeContactosOriginal[_listaDeContactosOriginal.Count - 1].PathImagen));
            _listaDeContactosOriginal.Add(new Contacto("Brian", "Marquez", " ", "a@gmail.com", "042643268451", _listaDeContactosOriginal.Count + 1, _listaDeContactosOriginal[_listaDeContactosOriginal.Count - 1].PathImagen));
            _listaDeContactosOriginal.Add(new Contacto("Alejandro", "Ramirez", "Carpintero", "a@gmail.com", "04242425403", _listaDeContactosOriginal.Count + 1, _listaDeContactosOriginal[_listaDeContactosOriginal.Count - 1].PathImagen));
            _listaDeContactosOriginal.Add(new Contacto("Francisco", "Ochoca", "El Lider", "a@gmail.com", "04165785546", _listaDeContactosOriginal.Count + 1, _listaDeContactosOriginal[_listaDeContactosOriginal.Count - 1].PathImagen));
            _listaDeContactosOriginal.Add(new Contacto("Maria", "Soto", " ", "a@gmail.com", "04126294867", _listaDeContactosOriginal.Count + 1, _listaDeContactosOriginal[_listaDeContactosOriginal.Count - 1].PathImagen));
            _listaDeContactosOriginal.Add(new Contacto("Alex", "Romero", " ", "a@gmail.com", "042651684165", _listaDeContactosOriginal.Count + 1, _listaDeContactosOriginal[_listaDeContactosOriginal.Count - 1].PathImagen));
            _listaDeContactosOriginal.Add(new Contacto("Gipsander", " ", " ", "a@gmail.com", "04148926340", _listaDeContactosOriginal.Count + 1, _listaDeContactosOriginal[_listaDeContactosOriginal.Count - 1].PathImagen));
            _listaDeContactosOriginal.Add(new Contacto("Maria", "Castillo", "Uñas", "a@gmail.com", "042665426515", _listaDeContactosOriginal.Count + 1, _listaDeContactosOriginal[_listaDeContactosOriginal.Count - 1].PathImagen));
